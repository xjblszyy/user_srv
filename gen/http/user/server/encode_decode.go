...
// EncodeRetrieveResponse returns an encoder for responses returned by the user
// retrieve endpoint.
...
// DecodeRetrieveRequest returns a decoder for requests sent to the user
// retrieve endpoint.
...
// EncodeSigninResponse returns an encoder for responses returned by the user
// signin endpoint.
...
// DecodeSigninRequest returns a decoder for requests sent to the user signin
// endpoint.
func DecodeSigninRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		...
		payload := NewSignin(&body)

		return payload, nil
	}
}

// EncodeSigninError returns an encoder for errors returned by the signin user
// endpoint.
...
func EncodeSendEmailResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*userviews.ResponseData)
		enc := encoder(ctx, w)
		body := NewSendEmailResponseBody(res.Projected)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeSendEmailRequest returns a decoder for requests sent to the user
// sendEmail endpoint.
...
// EncodeActiveEmailResponse returns an encoder for responses returned by the
// user activeEmail endpoint.
func EncodeActiveEmailResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*userviews.ResponseData)
		enc := encoder(ctx, w)
		body := NewActiveEmailResponseBody(res.Projected)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeActiveEmailRequest returns a decoder for requests sent to the user
// activeEmail endpoint.
func DecodeActiveEmailRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		var (
			code string
		...
		code = params["code"]
		payload := NewActiveEmailEmailCode(code)

		return payload, nil
	}
}

// EncodeActiveEmailError returns an encoder for errors returned by the
// activeEmail user endpoint.
func EncodeActiveEmailError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		en, ok := v.(ErrorNamer)
		if !ok {
		...
		case "code_invalide":
			res := v.(*goa.ServiceError)
			enc := encoder(ctx, w)
			body := NewActiveEmailCodeInvalideResponseBody(res)
			w.Header().Set("goa-error", "code_invalide")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		default:
			return encodeError(ctx, w, v)
