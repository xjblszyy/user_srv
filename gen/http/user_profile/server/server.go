...
// Server lists the userProfile service endpoint HTTP handlers.
type Server struct {
	Mounts   []*MountPoint
...
// New instantiates HTTP handlers for all the userProfile service endpoints.
func New(
	e *userprofile.Endpoints,
	mux goahttp.Muxer,
...
func (s *Server) Service() string { return "userProfile" }
...
// Mount configures the mux to serve the userProfile endpoints.
...
// MountRetrieveHandler configures the mux to serve the "userProfile" service
// "retrieve" endpoint.
...
// calls the "userProfile" service "retrieve" endpoint.
...
// MountCreateHandler configures the mux to serve the "userProfile" service
// "create" endpoint.
...
// calls the "userProfile" service "create" endpoint.
...
// MountSigninHandler configures the mux to serve the "userProfile" service
// "signin" endpoint.
...
// calls the "userProfile" service "signin" endpoint.
...
// MountUpdateHandler configures the mux to serve the "userProfile" service
// "update" endpoint.
...
// calls the "userProfile" service "update" endpoint.
